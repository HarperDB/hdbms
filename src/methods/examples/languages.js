...
export default [
  ...
  },
  {
    ...
    snippet: javascriptFetch,
  },
  {
    lang: 'javascript',
    variant: 'jQuery',
    syntax_mode: 'javascript',
    snippet: javascriptjQuery,
  },
  {
    lang: 'JavaScript',
    variant: 'XHR',
    syntax_mode: 'javascript',
    snippet: javascriptXHR,
  },
  {
    lang: 'C',
    variant: 'libcurl',
  ...
  },
  {
    ...
    variant: 'Request',
    syntax_mode: 'javascript',
    snippet: nodejsRequest,
  },
  {
    lang: 'nodejs',
    variant: 'Unirest',
    syntax_mode: 'javascript',
    snippet: nodejsUnirest,
  },
  {
    lang: 'Objective-C',
    variant: 'NSURLSession',
    syntax_mode: 'objectivec',
    snippet: objectiveCNSURLSession,
  },
  {
    lang: 'ocaml',
    variant: 'Cohttp',
  ...
  },
  {
    ...
    syntax_mode: 'php',
    snippet: phpHTTPRequest2,
  },
  {
    lang: 'powershell',
    variant: 'RestMethod',
    syntax_mode: 'bash',
    snippet: powershellRestMethod,
  },
  {
    lang: 'python',
    variant: 'http.client',
    syntax_mode: 'python',
    snippet: pythonHTTPClient,
  },
  {
    lang: 'python',
    variant: 'Requests',
    syntax_mode: 'python',
    snippet: pythonRequests,
  },
  {
    lang: 'Ruby',
    variant: 'Net::HTTP',
