...
function AuthLayout() {
	return (
		<div className='grid h-screen grid-cols-1 md:grid-cols-2'>
				<section className='items-center justify-center hidden text-white md:flex blue-pink-gradient'>
					<div>
						...
						<ul className='ps-5'>
							...
							<ListItem title='Fully Managed Cloud & 5G Instances' children={<span>Go from zero to code in minutes.</span>} />
							<ListItem title='Deploy Anywhere' children={
								<div className='mt-6'>
									<a
				...
				<section className='flex items-center justify-center bg-purple-dark dark:bg-black-dark'>
					<Outlet />
				</section>
