  ...
  return <>
      <Row className="floating-card-header">
        ...
        <Col className="text-end">
          <Button color="link" tabIndex="0" title="Filter Users" className="me-3" onClick={() => setTableState({
          ...tableState,
      ...
      <Card className="my-3">
        <CardBody className="react-table-holder">
          <DataTable columns={tableState.dataTableColumns} data={tableState.tableData} currentPage={tableState.page} pageSize={tableState.pageSize} totalPages={tableState.totalPages} showFilter={tableState.showFilter} sorted={tableState.sorted} loading={!users || tableState.loading && !tableState.autoRefresh} onFilteredChange={value => setTableState({
          ...tableState,
          filtered: value
          ...
          page: 0,
          pageSize: value
        })} onRowClick={rowData => rowClick(rowData.userId)} />
        </CardBody>
      </Card>
    </>;
}
