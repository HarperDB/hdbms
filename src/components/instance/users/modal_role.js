...
import { Modal, ModalHeader, ModalBody, Button, SelectDropdown, Col, Row } from '@nio/ui-kit';
    ...
    <Modal id="new-instance-modal" isOpen toggle={closeModal}>
      ...
      <ModalBody>
        <SelectDropdown
          ...
          className="mb-2"
          onChange={({ value }) => updateForm({ ...formData, newRole: value })}
        ...
        <Row>
          ...
          <Col sm="6">
            <Button block color="danger" onClick={updateRole}>do it</Button>
          </Col>
        </Row>
        {formState.error && (
