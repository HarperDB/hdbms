  ...
  return (
    <Row id="clustering">
      <Col xl="3" lg="4" md="6" xs="12">
        <InstanceManager items={clusterInstances.connected} itemType="connected" />
        {clusterInstances.unconnected.length ? <InstanceManager items={clusterInstances.unconnected} itemType="unconnected" /> : null}
        {clusterInstances.unreachable.length ? <InstanceManager items={clusterInstances.unreachable} itemType="unreachable" /> : null}
      ...
      <Col xl="9" lg="8" md="6" xs="12">
        {clusterInstances.connected.length ? (
          <DataTable instances={clusterInstances.connected} />
        ) : (
          <>
