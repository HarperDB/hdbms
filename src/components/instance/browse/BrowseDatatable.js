  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      if (isMounted) {
        setLoading(false);
        if (newData.error) {
          setTableContextState({ ...tableContextState, tableData: [], newEntityAttributes, hashAttribute, dataTableColumns, error: newData.error });
          setTableState({
            ...tableState,
            tableData: [],
            error,
          ...
          setTableContextState({ ...tableContextState, tableData: newData, newEntityAttributes, hashAttribute, dataTableColumns, error });
          setTableState({
            ...tableState,
            tableData: newData,
            newEntityAttributes,
