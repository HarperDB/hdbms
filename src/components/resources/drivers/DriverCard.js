        ...
        <Card className="integration-driver-card">
          <CardBody className="pt-3">
            ...
            <div className="d-block text-small text-truncate mt-1">
              docs:{' '}
              <a className="text-darkgrey" href={docs ? `http://cdn.cdata.com/help/${docsVersion}/${docs}` : urls[0].link} target="_blank" rel="noopener noreferrer">
                {docs ? `http://cdn.cdata.com/help/${docsVersion}/${docs}` : urls[0].link}
              </a>
            </div>
