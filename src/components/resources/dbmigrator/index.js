      ...
      <CardBody>
        ...
        <Row>
          <Col md="4" xs="12">
            ...
            <CardImg top width="100%" src="/images/migrator/screenshot1.png" alt="HarperDB Migrator Screenshot" />
          </Col>
          <Col md="4" xs="12">
            <b className="d-block my-3">Step 2: Select Entities For Migration</b>
            <CardImg top width="100%" src="/images/migrator/screenshot2.png" alt="HarperDB Migrator Screenshot" />
          </Col>
          <Col md="4" xs="12">
            <b className="d-block my-3">Step 3: Click Start Migration</b>
            <CardImg top width="100%" src="/images/migrator/screenshot3.png" alt="HarperDB Migrator Screenshot" />
          </Col>
        </Row>
      </CardBody>
    </Card>
