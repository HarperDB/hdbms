  ...
  return (
    <Row id="clustering">
      <Col xl="3" lg="4" md="5" xs="12">
        <span className="text-bold text-white mb-2">clustering</span>
        <Card className="my-3">
          <CardBody>
      ...
      <Col xl="9" lg="8" md="7" xs="12" className="pb-5">
        <span className="text-bold text-white mb-2">follow the steps below to enable clustering for this instance.</span>
        <Card className="my-3">
