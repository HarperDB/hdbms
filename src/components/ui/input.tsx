...
function Input({ className, type, ...props }: React.ComponentProps<'input'>) {
	return (
		<input
			...
			data-slot="input"
			className={cn(
				`border-input file:text-foreground placeholder:text-muted-foreground selection:bg-purple-light
        ...
        flex h-9 w-full min-w-0 rounded-md border bg-purple-dark-faded px-3 py-1 text-base text-white
        file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium 
        focus-visible:ring-1 focus-visible:outline-none focus-visible:ring-purple-light  disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 
