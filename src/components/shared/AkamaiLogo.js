        ...
        <g>
          <g>
            <path
              className="st0"
              style={{ fill: '#F38B00' }}
              d="M131.6,131.8h-16.8l14.5-29.3h0.2L131.6,131.8L131.6,131.8z M132.4,145l1,11.6h18.4l-6.1-67.7h-27.4
				l-34.7,67.7h18.8l5.8-11.6L132.4,145L132.4,145z"
            />
            <polygon
              className="st0"
              style={{ fill: '#F38B00' }}
              points="177.6,127 180.3,127 193.5,109.2 210.5,109.2 192.3,132 203.5,156.6 185.4,156.6 178.1,137.4
				175.4,137.4 171.3,156.6 155.8,156.6 170.1,88.9 185.7,88.9 			"
            />
            <path
              className="st0"
              style={{ fill: '#F38B00' }}
              d="M230.4,137c5.1,0,8.4,0.4,7.6,4.3c-1.1,5-3.2,5.8-9.7,5.8c-2.4,0-6.8,0-5.7-5.1
            ...
            <path
              className="st0"
              style={{ fill: '#F38B00' }}
              d="M281.6,109.2l-1.4,6.7h0.6c3.1-5.6,9.2-7.2,14.5-7.2c6.7,0,13.3,1.2,12.4,9.3h0.7c2.3-6.8,9.2-9.3,15.2-9.3
            ...
            <path
              className="st0"
              style={{ fill: '#F38B00' }}
              d="M361.2,137c5,0,8.4,0.4,7.6,4.3c-1,5-3.2,5.8-9.7,5.8c-2.3,0-6.8,0-5.7-5.1C354.3,137.7,357.4,137,361.2,137
            ...
            />
            <path className="st0" style={{ fill: '#F38B00' }} d="M403.4,156.6h-15.5l10-47.4h15.5L403.4,156.6L403.4,156.6z" />
          </g>
          <path
            className="st1"
            style={{ fill: '#009BDE' }}
            d="M91.5,173C57.1,162.5,32,130.7,32,93.1C32,55,57.6,22.9,92.6,12.8c3.6-1,2.6-3.4-1.7-3.4
			C44.4,9.4,6.6,46.9,6.6,93.1s37.7,83.6,84.3,83.6C95.2,176.7,95.4,174.2,91.5,173z"
          />
          <path
            className="st1"
            style={{ fill: '#009BDE' }}
            d="M48,112.6c-0.2-2.2-0.4-4.5-0.4-6.8c0-36.7,29.7-66.4,66.4-66.4c34.7,0,45.1,15.5,46.4,14.5
			c1.4-1.1-12.6-31.8-53.3-31.8c-36.7,0-66.4,29.7-66.4,66.4c0,8.5,1.6,16.6,4.5,24C46.4,115.7,48.3,115.7,48,112.6z"
          />
          <path
            className="st1"
            style={{ fill: '#009BDE' }}
            d="M75.8,64.8c17.2-7.5,38.9-7.7,60.2-0.3c14.3,5,22.6,12.1,23.3,11.8c1.1-0.5-8.3-15.5-25.4-21.9
			c-20.7-7.8-42.9-3.7-59.1,9C73,64.8,73.7,65.7,75.8,64.8z"
          />
          <path className="st0" style={{ fill: '#F38B00' }} d="M416.9,96.1c0,4.8-3.9,8.7-8.7,8.7c-4.8,0-8.7-3.9-8.7-8.7c0-4.8,3.9-8.7,8.7-8.7S416.9,91.3,416.9,96.1z" />
        </g>
      </g>
    </svg>
  );
