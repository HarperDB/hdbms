  ...
  return (
    <Row className="pagination">
      <Col xs="12" sm="2" className="previous">
        <Button className="mb-2 btn-pagination" color="purple" block onClick={() => onPageChange(page - 1)} disabled={!totalPages || page === 0}>
      ...
      <Col xs="12" sm="2" className="next">
        <Button className="mb-2 pull-right btn-pagination" block color="purple" onClick={() => onPageChange(page + 1)} disabled={!totalPages || page + 1 === totalPages}>
